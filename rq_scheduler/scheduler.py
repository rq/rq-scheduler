...
class Scheduler(object):
    ...
    def _create_job(self, func, args=None, kwargs=None, commit=True,
                    result_ttl=None, queue_name=None, timeout=None):
        """
    ...
    def enqueue_at(self, scheduled_time, func, timeout=None, *args, **kwargs):
        """
    ...
    def enqueue_periodic(self, scheduled_time, interval, repeat, func, timeout=None,
                         *args, **kwargs):
        """
    ...
    def schedule(self, scheduled_time, func, args=None, kwargs=None,
        ...
        job = self._create_job(func, args=args, kwargs=kwargs, commit=False,
                               result_ttl=result_ttl, queue_name=queue_name, timeout=timeout)
    ...
    def enqueue(self, scheduled_time, func, args=None, kwargs=None,
                interval=None, repeat=None, result_ttl=None, queue_name=None, timeout=None):
        """
        ...
        return self.schedule(scheduled_time, func, args, kwargs, interval,
                             repeat, result_ttl, queue_name=queue_name, timeout=timeout)
